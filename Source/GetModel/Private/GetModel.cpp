...
void FGetModelModule::StartupModule()
{
    ...
    FGlobalTabmanager::Get()->RegisterNomadTabSpawner(FGetModelModuleTabName, FOnSpawnTab::CreateRaw(this, &FGetModelModule::OnSpawnPluginTab)).SetDisplayName(LOCTEXT("FFGetModelModuleTabTitle", "Get Model and Material")).SetMenuType(ETabSpawnerMenuType::Hidden);
}
...
TSharedRef<SDockTab> FGetModelModule::OnSpawnPluginTab(const FSpawnTabArgs& SpawnTabArgs)
{
    ...
    TSharedRef<SDockTab> mainTab = SNew(SDockTab)
                                       ...
                                       .ShouldAutosize(true)
                                           [SNew(SScrollBox) + SScrollBox::Slot().Padding(10, 5)[SNew(SHorizontalBox) + SHorizontalBox::Slot().AutoWidth().HAlign(HAlign_Left).Padding(4, 4, 10, 4)[SNew(STextBlock).Text(FText::FromString(TEXT("TextureSize(X,Y):")))] + SHorizontalBox::Slot().HAlign(HAlign_Left).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(TextureSizeX, SSpinBox<int32>).MaxValue(16384).MinValue(1).Value(1024)] + SHorizontalBox::Slot().HAlign(HAlign_Left).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(TextureSizeY, SSpinBox<int32>).Value(1024).MaxValue(16384).MinValue(1)]]

                                            // bInstancingMultiActors.
                                            + SScrollBox::Slot().Padding(10, 5)[SNew(SHorizontalBox) + SHorizontalBox::Slot().HAlign(HAlign_Center).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(bInstancingMultiActors, SCheckBox).ToolTipText(FText::FromString(TEXT("Instancing Multi Actors"))).IsChecked(ECheckBoxState::Checked)] + SHorizontalBox::Slot().AutoWidth().HAlign(HAlign_Left).Padding(4, 4, 10, 4)[SNew(STextBlock).Text(FText::FromString(TEXT("Instancing Multi Actors")))]]

                                            // Checkbox: Use Vertex Data For Baking Material.
                                            + SScrollBox::Slot().Padding(10, 5)[SNew(SHorizontalBox) + SHorizontalBox::Slot().HAlign(HAlign_Center).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(bUseVertexDataForBakingMaterial, SCheckBox).ToolTipText(FText::FromString(TEXT("Use Vertex Data For Baking Material"))).IsChecked(ECheckBoxState::Checked)] + SHorizontalBox::Slot().AutoWidth().HAlign(HAlign_Left).Padding(4, 4, 10, 4)[SNew(STextBlock).Text(FText::FromString(TEXT("Use Vertex Data For Baking Material")))]]

                                            // Checkbox Merge Physics Data.
                                            + SScrollBox::Slot().Padding(10, 5)[SNew(SHorizontalBox) + SHorizontalBox::Slot().HAlign(HAlign_Center).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(bMergePhysicsData, SCheckBox).ToolTipText(FText::FromString(TEXT("Merge Physics Data"))).IsChecked(ECheckBoxState::Unchecked)] + SHorizontalBox::Slot().AutoWidth().HAlign(HAlign_Left).Padding(4, 4, 10, 4)[SNew(STextBlock).Text(FText::FromString(TEXT("Merge Physics Data")))]] + SScrollBox::Slot().Padding(10, 5)[SNew(SHorizontalBox) + SHorizontalBox::Slot().HAlign(HAlign_Center).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(bNormalMap, SCheckBox).ToolTipText(FText::FromString(TEXT("Export Normal Map"))).IsChecked(ECheckBoxState::Checked)] + SHorizontalBox::Slot().AutoWidth().HAlign(HAlign_Left).Padding(4, 4, 10, 4)[SNew(STextBlock).Text(FText::FromString(TEXT("Export Normal Map")))]]

                                            // Checkbox mrs.
                                            + SScrollBox::Slot().Padding(10, 5)[SNew(SHorizontalBox) + SHorizontalBox::Slot().HAlign(HAlign_Center).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(bMRSMap, SCheckBox).ToolTipText(FText::FromString(TEXT("Export MRS Map"))).IsChecked(ECheckBoxState::Checked)] + SHorizontalBox::Slot().AutoWidth().HAlign(HAlign_Left).Padding(4, 4, 10, 4)[SNew(STextBlock).Text(FText::FromString(TEXT("Export MRS Map")))]]

                                            // Checkbox o.
                                            + SScrollBox::Slot().Padding(10, 5)[SNew(SHorizontalBox) + SHorizontalBox::Slot().HAlign(HAlign_Center).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(bOpacityMap, SCheckBox).ToolTipText(FText::FromString(TEXT("Export Opacity Map"))).IsChecked(ECheckBoxState::Checked)] + SHorizontalBox::Slot().AutoWidth().HAlign(HAlign_Left).Padding(4, 4, 10, 4)[SNew(STextBlock).Text(FText::FromString(TEXT("Export Opacity Map")))]]

                                            // Checkbox e.
                                            + SScrollBox::Slot().Padding(10, 5)[SNew(SHorizontalBox) + SHorizontalBox::Slot().HAlign(HAlign_Center).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(bEmissiveMap, SCheckBox).ToolTipText(FText::FromString(TEXT("Export Emissive Map"))).IsChecked(ECheckBoxState::Unchecked)] + SHorizontalBox::Slot().AutoWidth().HAlign(HAlign_Left).Padding(4, 4, 10, 4)[SNew(STextBlock).Text(FText::FromString(TEXT("Export Emissive Map")))]]

                                            // Button.
                                            + SScrollBox::Slot().Padding(10, 5)[SNew(SHorizontalBox) + SHorizontalBox::Slot().HAlign(HAlign_Center).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(GetMaterialBtn, SButton).Text(LOCTEXT("GetMaterial", "Get material")).OnClicked_Raw(this, &FGetModelModule::GenerateMergeObj)] + SHorizontalBox::Slot().HAlign(HAlign_Center).Padding(4, 4, 10, 4).AutoWidth()[SAssignNew(GetObjBtn, SButton).Text(LOCTEXT("GetObjAndMtl", "Export obj And mtl")).OnClicked_Raw(this, &FGetModelModule::ExportMergeObj)]]];
    return mainTab;
}
